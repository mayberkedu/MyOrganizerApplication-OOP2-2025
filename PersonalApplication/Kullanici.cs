...
namespace MyOrganizerApplication
{
    public class Kullanici
    {
        ...
        public Kullanici(string username, string password, bool rememberMe, string usertypes, string name, string surname, string phoneNumber, string address, string email, string photo, string salary)
        {
        ...
        {
            return this.username.Equals(txtId) && this.accoundPassword.Equals(txtPassword);
        }
        public bool IsValid(string txtId, string txtPassword, string usertypes)
        {
            return this.username.Equals(txtId) && this.accoundPassword.Equals(txtPassword) && (this.usertypes.Equals(usertypes));
        }
